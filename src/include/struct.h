 ...
 *
 * t_parametres est une structure unique déclaré en global,
 * elle est très importante cal elle stocke touts les
...
{
    //GRAPHISMES
    int mode;//0 fen�tr� - 1 Plein Ecran
...
typedef struct
{
    ...
    int texture_fond_jeu_selectione;
